...
constexpr float particleDefaultRadius = 0.3f * cellHeight; // particle radius w.r.t. cell size
constexpr float dx                    = 2.0f * particleDefaultRadius;
...
constexpr int numX             = static_cast<int>((relWaterWidth * maxwidth - 2.0f * cellHeight - 2.0f * particleDefaultRadius) / dx);
constexpr int numY             = static_cast<int>((relWaterHeight * maxheight - 2.0f * cellHeight - 2.0f * particleDefaultRadius) / dy);
